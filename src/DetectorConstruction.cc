...
*/
  ...
  fWireThick = gas2Y;
   ...
   //Set Sensitive Detector For each wire
   for(G4int i = 0; i < fWireNum; i++)
     fLogicWireSD[i] -> SetSensitiveDetector(fchamberSD);
   
   //originally gas2 for was sensitive detector
   //fLogicVDCgas2[0]->SetSensitiveDetector(fchamberSD); 
   //fLogicVDCgas2[1]->SetSensitiveDetector(fchamberSD); 
	...
	//Vis Attributes for Wires/WirePlanes 
	//fLogicVDCgas2[0]->SetVisAttributes(VDCGasVisAtt);
	//fLogicVDCgas2[1]->SetVisAttributes(VDCGasVisAtt);
	for(G4int i = 0; i < fWireNum; i++)
	  fLogicWireSD[i]->SetVisAttributes(VDCGasVisAtt);

	//fLogicVDCgas1->SetVisAttributes(G4VisAttributes::Invisible);
	//fLogicVDCgas2[0]->SetVisAttributes(G4VisAttributes::Invisible);
	//fLogicVDCgas2[1]->SetVisAttributes(G4VisAttributes::Invisible);
