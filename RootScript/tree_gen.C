...
//This file is used to convert output files (.dat files) to root file
...
//Functions read and data from each event and store them to a BH_Event data structure
...
//Control function to set conditions of applying In... funtions to read data of each event to a BH_Event structure
...
//Main function used to read data from a .dat file and convert it to a ttree.
void MakeTree(void){
